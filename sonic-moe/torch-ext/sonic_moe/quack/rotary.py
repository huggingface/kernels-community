...
@cute_op(
    add_op_namespace_prefix("_rotary_fwd_out"),
    mutates_args=("out",),
    device_types="cuda",
...
@cute_op(
    add_op_namespace_prefix("_rotary_fwd_inplace"),
    mutates_args=("x",),
    device_types="cuda",
...
@cute_op(
    add_op_namespace_prefix("_rotary_inplace_bwd"),
    mutates_args=(),
    device_types="cuda",
...
@cute_op(
    add_op_namespace_prefix("_rotary_qkv_inplace"),
    mutates_args=("qkv",),
    device_types="cuda",
...
@cute_op(
    add_op_namespace_prefix("_rotary_qkv_inplace_bwd"),
    mutates_args=(),
    device_types="cuda",
