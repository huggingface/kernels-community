...
from ...ops.common.chunk_h import chunk_fwd_h
from ...ops.gla.chunk import chunk_gla_bwd_dA, chunk_gla_bwd_dv, chunk_gla_fwd_o_gk
...
def chunk_rwkv6(
    ...
    **kwargs,
    ...
    Examples::
        ...
        >>> from ...ops.rwkv6 import chunk_rwkv6
