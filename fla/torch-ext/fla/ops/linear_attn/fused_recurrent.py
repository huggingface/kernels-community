...
from ...ops.linear_attn.utils import normalize_with_z_state
from ...ops.simple_gla.fused_recurrent import fused_recurrent_simple_gla
...
def fused_recurrent_linear_attn(
    ...
    Args:
        ...
        reverse (bool):
            Whether to scan in reverse order. Default: `False`.
        normalize (bool):
