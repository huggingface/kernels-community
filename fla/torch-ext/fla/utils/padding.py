...
# NOTE: this is a trimmed-down copy of fla/layers/utils.py, vendored here because
# this package only ships fla/{ops,modules,utils} and not the fla/layers package.
# It carries only pad_input/unpad_input (and their direct helpers), which is what
# fla.ops.deltaformer needs; the layer/cache-oriented helpers from the original
# file (unpad_hidden_states, repad_hidden_states, *_layer_cache, ...) are omitted.
