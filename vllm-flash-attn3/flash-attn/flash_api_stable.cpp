...
mha_fwd_get_scheduler_metadata(
    ...
    if (scheduler_needs_semaphore || use_dynamic_split) {
        tile_count_semaphore = torch::stable::new_empty(
            seqused_k,
            {int(scheduler_needs_semaphore) + int(use_dynamic_split) * params.b},
        ...
        params.num_splits_dynamic_ptr = use_dynamic_split ? static_cast<int*>(tile_count_semaphore.data_ptr()) + 1 : nullptr;
    }
...
mha_fwd(Tensor q,   // (b, s_q, h, d) or (total_q, h, d) if there is cu_seqlens_q
    ...
    if (scheduler_needs_semaphore || use_dynamic_split) {
        ...
        if (scheduler_metadata_.has_value()) {
            ...
            tile_count_semaphore = torch::stable::new_empty(q, {metadata_size}, std::make_optional(torch::headeronly::ScalarType::Int));
        }
        if (scheduler_needs_semaphore && !use_dynamic_split) {
            torch::stable::zero_(tile_count_semaphore);  // If varlen we'll manually do the zero-ing
        }
        params.tile_count_semaphore = scheduler_needs_semaphore ? static_cast<int*>(tile_count_semaphore.data_ptr()) : nullptr;
        params.num_splits_dynamic_ptr = use_dynamic_split ? static_cast<int*>(tile_count_semaphore.data_ptr()) + 1 : nullptr;
    }
...
mha_bwd(
    Tensor dout,  // (b, s_q, h, d) or (total_q, h, d) if there is cu_seqlens_q
    ...
    Tensor out,   // (b, s_q, h, d) or (total_q, h, d) if there is cu_seqlens_q
...
void boxed_mha_fwd(
    ...
    stack[0] = torch::stable::detail::from(out_);
    stack[1] = torch::stable::detail::from(softmax_lse);
    stack[2] = torch::stable::detail::from(out_accum);
    stack[3] = torch::stable::detail::from(softmax_lse_accum);
}
...
void boxed_mha_bwd(
    ...
    auto dout = torch::stable::detail::to<Tensor>(stack[0]);
    auto q = torch::stable::detail::to<Tensor>(stack[1]);
    auto k = torch::stable::detail::to<Tensor>(stack[2]);
    auto v = torch::stable::detail::to<Tensor>(stack[3]);
    auto out = torch::stable::detail::to<Tensor>(stack[4]);
    auto softmax_lse = torch::stable::detail::to<Tensor>(stack[5]);
    auto dq = torch::stable::detail::to<std::optional<Tensor>>(stack[6]);
    auto dk = torch::stable::detail::to<std::optional<Tensor>>(stack[7]);
    auto dv = torch::stable::detail::to<std::optional<Tensor>>(stack[8]);
    ...
    auto seqused_q = torch::stable::detail::to<std::optional<Tensor>>(stack[11]);
    auto seqused_k = torch::stable::detail::to<std::optional<Tensor>>(stack[12]);
    auto max_seqlen_q = torch::stable::detail::to<std::optional<int64_t>>(stack[13]);
    auto max_seqlen_k = torch::stable::detail::to<std::optional<int64_t>>(stack[14]);
    auto softmax_scale = torch::stable::detail::to<double>(stack[15]);
    ...
    auto softcap = torch::stable::detail::to<double>(stack[19]);
    auto deterministic = torch::stable::detail::to<bool>(stack[20]);
    auto sm_margin = torch::stable::detail::to<int64_t>(stack[21]);
    ...
    stack[0] = torch::stable::detail::from(dq_);
    stack[1] = torch::stable::detail::from(dk_);
    stack[2] = torch::stable::detail::from(dv_);
    stack[3] = torch::stable::detail::from(softmax_d);
    stack[4] = torch::stable::detail::from(softmax_lse_log2);
    stack[5] = torch::stable::detail::from(dq_accum);
    stack[6] = torch::stable::detail::from(dk_accum);
    stack[7] = torch::stable::detail::from(dv_accum);
}
...
void boxed_mha_combine(
    ...
    auto out_partial = torch::stable::detail::to<Tensor>(stack[0]);
    auto lse_partial = torch::stable::detail::to<Tensor>(stack[1]);
    auto out = torch::stable::detail::to<std::optional<Tensor>>(stack[2]);
    auto out_dtype = torch::stable::detail::to<std::optional<torch::headeronly::ScalarType>>(stack[3]);
...
STABLE_TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, m) {
    m.def("fwd("
        "Tensor q,"
        "Tensor k,"
        "Tensor v,"
...
STABLE_TORCH_LIBRARY_IMPL_EXPAND(TORCH_EXTENSION_NAME, CUDA, m) {
