...
@torch.library.custom_op(
    add_op_namespace_prefix("scatter2scatter"), mutates_args={"output"}
)
...
@torch.library.custom_op(add_op_namespace_prefix("groupXtY"), mutates_args={"DW"})
...
@torch.library.custom_op(add_op_namespace_prefix("group"), mutates_args={"Y"})
