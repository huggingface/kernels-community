...
using fmha_block_tile = ck_tile::sequence<128, 64, 32, 64, 32, 64>;
...
using trait = fmha_fwd_traits_<64, FmhaFwdBf16, true,128, 64, 32, 64, 32, 64, true,
...
float fmha_fwd_<trait, ck_tile::gfx9_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d64_bf16_group_b128x64x32x64x32x64_r4x1x1_r4x1x1_w32x32x16_w32x32x16_qr_async_vr_psskddv_nlogits_nbias_mask_nlse_ndropout_nskip_nqscale_ntrload_nsink" << std::flush;
