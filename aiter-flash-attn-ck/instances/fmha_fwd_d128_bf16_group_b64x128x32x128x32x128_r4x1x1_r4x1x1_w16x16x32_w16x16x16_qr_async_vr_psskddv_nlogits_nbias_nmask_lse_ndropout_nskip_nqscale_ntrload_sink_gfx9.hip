...
using trait = fmha_fwd_traits_<128, FmhaFwdBf16, true,64, 128, 32, 128, 32, 128, true,
                        ck_tile::BlockFmhaPipelineEnum::QRKSVS_ASYNC, false, fmha_mask, ck_tile::BlockAttentionBiasEnum::NO_BIAS, true, false, ck_tile::BlockAttentionQuantScaleEnum::NO_SCALE, true, true, true, true, false, false, true>;
...
float fmha_fwd_<trait, ck_tile::gfx9_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d128_bf16_group_b64x128x32x128x32x128_r4x1x1_r4x1x1_w16x16x32_w16x16x16_qr_async_vr_psskddv_nlogits_nbias_nmask_lse_ndropout_nskip_nqscale_ntrload_sink" << std::flush;
