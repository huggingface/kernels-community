...
from ..blockscaled.quantize import (
    to_mx_compiled,
    to_mxfp4_compiled,
    to_nvfp4_compiled,
)
...
def blockscaled_quantize(
    ...
    """
    from ..blockscaled.quantize import to_mx_compiled, to_mxfp4_compiled, to_nvfp4_compiled
...
def create_blockscaled_varlen_k_operands(
    ...
    *,
    ...
    from ..blockscaled.quantize import to_mx_compiled
