...
_epi_ops = submodule("epi_ops")
ColVecReduce = _epi_ops.ColVecReduce
EpiSmemBytes = _epi_ops.EpiSmemBytes
RowVecLoad = _epi_ops.RowVecLoad
TileLoad = _epi_ops.TileLoad
TileStore = _epi_ops.TileStore
