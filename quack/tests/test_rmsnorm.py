...
_rmsnorm_mod = submodule("rmsnorm")
_compile_rmsnorm_fwd = _rmsnorm_mod._compile_rmsnorm_fwd
rmsnorm = _rmsnorm_mod.rmsnorm
rmsnorm_bwd = _rmsnorm_mod.rmsnorm_bwd
rmsnorm_bwd_ref = _rmsnorm_mod.rmsnorm_bwd_ref
rmsnorm_bwd_tuned = _rmsnorm_mod.rmsnorm_bwd_tuned
rmsnorm_fwd = _rmsnorm_mod.rmsnorm_fwd
rmsnorm_fwd_tuned = _rmsnorm_mod.rmsnorm_fwd_tuned
rmsnorm_ref = _rmsnorm_mod.rmsnorm_ref

_rmsnorm_config = submodule("rmsnorm_config")
RmsNormBwdConfig = _rmsnorm_config.RmsNormBwdConfig
RmsNormFwdConfig = _rmsnorm_config.RmsNormFwdConfig
