...
_rotary = submodule("rotary")
apply_rotary = _rotary.apply_rotary
apply_rotary_emb = _rotary.apply_rotary_emb
apply_rotary_emb_kv_ = _rotary.apply_rotary_emb_kv_
apply_rotary_emb_qkv_ = _rotary.apply_rotary_emb_qkv_
