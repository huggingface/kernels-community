...
_complex = submodule("complex")
Complex64 = _complex.Complex64
allocate_smem_complex = _complex.allocate_smem_complex
complex_storage = _complex.complex_storage
recast_to_complex64 = _complex.recast_to_complex64

run_traced = submodule("testing.trace").run_traced
