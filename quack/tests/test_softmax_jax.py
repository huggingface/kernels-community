...
def jax_env():
    ...
    # The `kernels` loader registers the package under a randomized name, so
    # the JAX bindings have to be resolved relative to it.
    softmax_mod = pytest.importorskip(f"{quack.__name__}.softmax_jax")
