...
_hadamard = submodule("transform.hadamard")
hadamard_transform = _hadamard.hadamard_transform
hadamard_transform_fwd = _hadamard.hadamard_transform_fwd
hadamard_transform_ref = _hadamard.hadamard_transform_ref
