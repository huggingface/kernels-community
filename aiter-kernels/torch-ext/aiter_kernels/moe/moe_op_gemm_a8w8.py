...
from aiter_kernels._triton_kernels.moe.moe_op_gemm_a8w8 import (
    _moe_gemm_a8w8,
)
...
def moe_gemm_a8w8(
    ...
    if w_has_mx:
        stride_w_mx_e = w_scales.stride(0)
        stride_w_mx_k = w_scales.stride(1)
        stride_w_mx_n = w_scales.stride(2)
    else:
        stride_w_mx_e = 0
        stride_w_mx_k = 0
        stride_w_mx_n = 0
