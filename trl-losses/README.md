...
[`huggingface/kernels-community`](https://github.com/huggingface/kernels-community/tree/main/trl-losses).

```python
from kernels import get_kernel

trl_losses = get_kernel("kernels-community/trl-losses", version=1)
