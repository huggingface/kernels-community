...
#pragma omp parallel for
      for (int i = 0; i < num_tokens; ++i)
      {
        ...
        FP32Vec16 fp32_s_variance(s_variance);
        ...
        for (int j = 0; j < hidden_size; j += VEC_ELEM_NUM)
        {
          ...
          FP32Vec16 fp32_out = fp32_x * fp32_s_variance * fp32_w;
...
#pragma omp parallel
      {
        ...
        for (int i = start; i < end; ++i)
        {
          ...
          FP32Vec16 fp32_inv_rms(inv_rms);
          ...
          FP32Vec16 fp32_inv_rms3(inv_rms3);
          FP32Vec16 fp32_S_over_H(S_over_H);
          ...
          for (int j = 0; j < HS; j += VEC_ELEM_NUM)
          {
            ...
            FP32Vec16 term1 = fp32_g_out * fp32_w * fp32_inv_rms;
            FP32Vec16 term2 = fp32_x * fp32_inv_rms3 * fp32_S_over_H;
            FP32Vec16 fp32_grad_in = term1 - term2;
