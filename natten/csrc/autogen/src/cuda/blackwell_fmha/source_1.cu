...
void blackwell_fmha_bfloat16_256x128x32(
  ...
  using Kernel = natten::cuda::fmha_blackwell::KernelForward<
    cutlass::bfloat16_t, GemmShape, false, cutlass::fmha::collective::NoMask, /* kIsVarlen= */ false>;
  using KernelWithResidualMask = natten::cuda::fmha_blackwell::KernelForward<
    cutlass::bfloat16_t, GemmShape, false, cutlass::fmha::collective::ResidualMask, /* kIsVarlen= */ false>;
  using KernelWithCausalMask = natten::cuda::fmha_blackwell::KernelForward<
    cutlass::bfloat16_t, GemmShape, false, cutlass::fmha::collective::CausalMask<true>, /* kIsVarlen= */ false>;
...
void blackwell_fmha_bfloat16_256x128x32_persistent(
  ...
  using GemmShape = cute::tuple<cute::Int<256>, cute::Int<128>, cute::Int<32>>;
  using Kernel = natten::cuda::fmha_blackwell::KernelForward<
    cutlass::bfloat16_t, GemmShape, true, cutlass::fmha::collective::NoMask, /* kIsVarlen= */ false>;
  using KernelWithResidualMask = natten::cuda::fmha_blackwell::KernelForward<
    cutlass::bfloat16_t, GemmShape, true, cutlass::fmha::collective::ResidualMask, /* kIsVarlen= */ false>;
  using KernelWithCausalMask = natten::cuda::fmha_blackwell::KernelForward<
    cutlass::bfloat16_t, GemmShape, true, cutlass::fmha::collective::CausalMask<true>, /* kIsVarlen= */ false>;
