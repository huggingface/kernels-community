...
void blackwell_fmha_backward_float16_128x128x32(
  ...
  auto run = [&](auto kIsDeterministic) {
    ...
    using Kernel = natten::cuda::fmha_blackwell::KernelBackward<
      cutlass::half_t, GemmShape, cutlass::fmha::collective::NoMask, /* kIsVarlen= */ false, IsDeterministic>;
    using KernelWithResidualMask = natten::cuda::fmha_blackwell::KernelBackward<
      cutlass::half_t, GemmShape, cutlass::fmha::collective::ResidualMaskForBackward, /* kIsVarlen= */ false, IsDeterministic>;
    using KernelWithCausalMask = natten::cuda::fmha_blackwell::KernelBackward<
      cutlass::half_t, GemmShape, cutlass::fmha::collective::CausalForBackwardMask<true>, /* kIsVarlen= */ false, IsDeterministic>;
