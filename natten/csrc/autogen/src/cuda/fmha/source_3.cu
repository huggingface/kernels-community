...
fmha_backward_64x64x32_sm50_float16(typename AttentionBackwardKernel<cutlass::half_t, cutlass::arch::Sm50, true, 64, 64, 32, false>::Params p) {
  ...
  AttentionBackwardKernel<cutlass::half_t, cutlass::arch::Sm50, true, 64, 64, 32, false>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: fmha kernel `fmha_backward_64x64x32_sm50_float16` was built for SM50, but attempted to launch from SM%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
...
fmha_backward_64x64x64_sm50_float16(typename AttentionBackwardKernel<cutlass::half_t, cutlass::arch::Sm50, true, 64, 64, 64, false>::Params p) {
  ...
  AttentionBackwardKernel<cutlass::half_t, cutlass::arch::Sm50, true, 64, 64, 64, false>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: fmha kernel `fmha_backward_64x64x64_sm50_float16` was built for SM50, but attempted to launch from SM%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
...
fmha_backward_64x64x128_sm50_float16(typename AttentionBackwardKernel<cutlass::half_t, cutlass::arch::Sm50, true, 64, 64, 128, false>::Params p) {
  ...
  AttentionBackwardKernel<cutlass::half_t, cutlass::arch::Sm50, true, 64, 64, 128, false>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: fmha kernel `fmha_backward_64x64x128_sm50_float16` was built for SM50, but attempted to launch from SM%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
...
fmha_backward_64x64x65536_sm50_float16(typename AttentionBackwardKernel<cutlass::half_t, cutlass::arch::Sm50, true, 64, 64, 65536, false>::Params p) {
  ...
  AttentionBackwardKernel<cutlass::half_t, cutlass::arch::Sm50, true, 64, 64, 65536, false>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: fmha kernel `fmha_backward_64x64x65536_sm50_float16` was built for SM50, but attempted to launch from SM%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
...
fmha_backward_64x64x32_sm70_float32(typename AttentionBackwardKernel<float, cutlass::arch::Sm70, true, 64, 64, 32, false>::Params p) {
  ...
  AttentionBackwardKernel<float, cutlass::arch::Sm70, true, 64, 64, 32, false>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: fmha kernel `fmha_backward_64x64x32_sm70_float32` was built for SM70, but attempted to launch from SM%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
...
fmha_backward_64x64x64_sm70_float32(typename AttentionBackwardKernel<float, cutlass::arch::Sm70, true, 64, 64, 64, false>::Params p) {
  ...
  AttentionBackwardKernel<float, cutlass::arch::Sm70, true, 64, 64, 64, false>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: fmha kernel `fmha_backward_64x64x64_sm70_float32` was built for SM70, but attempted to launch from SM%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
...
fmha_backward_64x64x128_sm70_float32(typename AttentionBackwardKernel<float, cutlass::arch::Sm70, true, 64, 64, 128, false>::Params p) {
  ...
  AttentionBackwardKernel<float, cutlass::arch::Sm70, true, 64, 64, 128, false>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: fmha kernel `fmha_backward_64x64x128_sm70_float32` was built for SM70, but attempted to launch from SM%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
...
fmha_backward_64x64x65536_sm70_float32(typename AttentionBackwardKernel<float, cutlass::arch::Sm70, true, 64, 64, 65536, false>::Params p) {
  ...
  AttentionBackwardKernel<float, cutlass::arch::Sm70, true, 64, 64, 65536, false>::attention_kernel(p);
  return;
#endif
#endif
    printf(
        "FATAL: fmha kernel `fmha_backward_64x64x65536_sm70_float32` was built for SM70, but attempted to launch from SM%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
}
} 
