...
void hopper_fmha_backward_bfloat16_128x128x64(
  ...
  using Kernel = natten::cuda::fmha_hopper::KernelBackward<
    cutlass::bfloat16_t, GemmShape, cutlass::fmha::collective::DefaultFusion, /* kIsVarlen= */ false>;
  using KernelWithResidualMask = natten::cuda::fmha_hopper::KernelBackward<
    cutlass::bfloat16_t, GemmShape, cutlass::fmha::collective::ResidualFusion, /* kIsVarlen= */ false>;
  using KernelWithCausalMask = natten::cuda::fmha_hopper::KernelBackward<
    cutlass::bfloat16_t, GemmShape, cutlass::fmha::collective::CausalFusion, /* kIsVarlen= */ false>;
