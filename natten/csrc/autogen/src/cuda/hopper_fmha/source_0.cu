...
void hopper_fmha_float16_64x128x32(
  ...
  using Kernel = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::NonPersistent, cutlass::fmha::collective::DefaultFusion, /* kIsVarlen= */ false>;
  using KernelWithResidualMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::NonPersistent, cutlass::fmha::collective::ResidualFusion, /* kIsVarlen= */ false>;
  using KernelWithCausalMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::NonPersistent, cutlass::fmha::collective::CausalFusion, /* kIsVarlen= */ false>;
