...
void hopper_fmha_bfloat16_128x128x128_pp(
  ...
  using Kernel = natten::cuda::fmha_hopper::KernelForward<
    cutlass::bfloat16_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::WSPingpong, cutlass::fmha::collective::DefaultFusion, /* kIsVarlen= */ false>;
  using KernelWithResidualMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::bfloat16_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::WSPingpong, cutlass::fmha::collective::ResidualFusion, /* kIsVarlen= */ false>;
  using KernelWithCausalMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::bfloat16_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::WSPingpong, cutlass::fmha::collective::CausalFusion, /* kIsVarlen= */ false>;
