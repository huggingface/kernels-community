...
void hopper_fmha_float16_128x128x128_coop(
  ...
  using Kernel = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::WSCooperative, cutlass::fmha::collective::DefaultFusion, /* kIsVarlen= */ false>;
  using KernelWithResidualMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::WSCooperative, cutlass::fmha::collective::ResidualFusion, /* kIsVarlen= */ false>;
  using KernelWithCausalMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::WSCooperative, cutlass::fmha::collective::CausalFusion, /* kIsVarlen= */ false>;
...
void hopper_fmha_float16_128x128x128_pp(
  ...
  using GemmShape = cute::tuple<cute::Int<128>, cute::Int<128>, cute::Int<128>>;
  using Kernel = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::WSPingpong, cutlass::fmha::collective::DefaultFusion, /* kIsVarlen= */ false>;
  using KernelWithResidualMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::WSPingpong, cutlass::fmha::collective::ResidualFusion, /* kIsVarlen= */ false>;
  using KernelWithCausalMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t, GemmShape, natten::cuda::hopper::HopperKernelSchedule::WSPingpong, cutlass::fmha::collective::CausalFusion, /* kIsVarlen= */ false>;

  // Varlen kernels
  using VarlenKernelWithResidualMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t,
    GemmShape,
    natten::cuda::hopper::HopperKernelSchedule::WSPingpong,
    cutlass::fmha::collective::ResidualFusion,
    /* kIsVarlen= */ true>;
  using VarlenKernelWithCausalMask = natten::cuda::fmha_hopper::KernelForward<
    cutlass::half_t,
