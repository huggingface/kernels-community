...
void {kernel_name}(
  ...
  using Kernel = natten::cuda::fna_blackwell::KernelForward<
    {dtype}, Causal, QTileShape, KVTileShape, Config, {is_persistent}>;
...
class NaDimDispatcher:
    ...
    def get_dispatcher(self):
        ...
        dispatcher_str += "    else { \\\n"
        dispatcher_str += (
            '      throw std::runtime_error("Blackwell FNA forward kernel dispatch failed! '
...
class DTypeDispatcher:
    ...
    def get_dispatcher(self):
        ...
        dispatcher_str += (
            ...
            + f"{self.na_dim}D forward kernel dispatch failed! "
...
class HeadDimDispatcher:
    ...
    def get_dispatcher(self):
        ...
        dispatcher_str += (
            ...
            '"Blackwell FNA forward kernel dispatch failed! '
