...
void {kernel_name}(
  ...
  using Kernel = natten::cuda::fmha_hopper::KernelForward<
    {dtype}, GemmShape, {kernel_type}, cutlass::fmha::collective::DefaultFusion, /* kIsVarlen= */ false>;
  using KernelWithResidualMask = natten::cuda::fmha_hopper::KernelForward<
    {dtype}, GemmShape, {kernel_type}, cutlass::fmha::collective::ResidualFusion, /* kIsVarlen= */ false>;
  using KernelWithCausalMask = natten::cuda::fmha_hopper::KernelForward<
    {dtype}, GemmShape, {kernel_type}, cutlass::fmha::collective::CausalFusion, /* kIsVarlen= */ false>;
...
class DTypeDispatcher:
    ...
    def get_dispatcher(self):
        ...
        dispatcher_str += "    else { \\\n"
        dispatcher_str += (
            '      throw std::runtime_error("Hopper FMHA forward kernel dispatch failed! '
...
class HeadDimDispatcher:
    ...
    def get_dispatcher(self):
        ...
        dispatcher_str += (
            ...
            '"Hopper FMHA forward kernel dispatch failed! '
...
class ConfigDispatcher:
    ...
    def get_dispatcher(self):
        ...
        dispatcher_str += (
            "      throw std::runtime_error("
            '"Hopper FMHA forward kernel dispatch failed! '
            "It got invalid Q tile, KV tile, and schedule "
